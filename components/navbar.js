...
import { Disclosure } from "@headlessui/react"; //! UI para el boton de disclousure
              ...
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                ...
                <Disclosure.Button
                  ...
                  className="px-2 py-1 ml-auto text-gray-500 rounded-md lg:hidden 
                             ...
                             focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700">
                  <svg
                  ...
                  <>
                    {navigation.map((item, index) => (
                      ...
                      className="w-full px-4 py-2 -ml-4 text-gray-500 
                                  rounded-md dark:text-gray-300 hover:text-indigo-500 focus:text-indigo-500 
                    ...
                    className="w-full px-6 py-2 mt-3 text-center text-white 
                                bg-indigo-600 rounded-md lg:ml-5">         
                        Get Started
                    </Link>
                  </>
                </Disclosure.Panel>
          ...
          <ul className="items-center justify-end flex-1 pt-6 list-none lg:pt-0 lg:flex">
            {navigation.map((menu, index) => (
              <li className="mr-3 nav__item" key={index}>
                <Link href="/" 
                      className="inline-block px-4 py-2 text-lg font-normal 
