  ...
  return (
    <>
      ...
      <div className="text-blueGray-700">
            ...
            <div className="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden">
              ...
              <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                <li className="items-center">
                  <a
                    href="./dashboard.html"
                    className="text-xs uppercase py-3 font-bold block hover:text-indigo-600"
                  >
                ...
                <li className="items-center">
                  ...
                  >
                    <i className=" mr-2 text-sm "></i>Configuracion
                  </a>
                </li>
                <li className="items-center">
                  <a
                  ...
                  >
                    <i className=" mr-2 text-sm text-blueGray-300"></i>Nombre
                  </a>
                </li>
                <li className="items-center">
                  <a
              ...
              <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
                <li className="items-center">
                  <a
                    ...
                    className="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                  >
                    <i className="text-blueGray-300 mr-2 text-sm"></i> Home{" "}
                  </a>
                </li>
                <li className="items-center">
                  <a
        ...
        <div className="relative md:ml-64 bg-blueGray-50"></div>
      </div>
      <div class="relative bg-indigo-700 md:pt-14 pb-10 pt-12"></div>
    </>
  );
};
