        ...
        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Alquileres</span>
            </div>
          </div>
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              <span className="inline-block text-2xl font-bold">8</span>
          ...
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            business?.cowork_spaces?.map((card) => ( 
              ...
              <span className="list-decimal text-2xl font-bold">{card.reserves?.length}</span>
            ))
          }
